...
export default function SiteFooter(){return <footer><div className="shell footer-main footer-official">
  <div><a className="brand footer-brand" href="/"><img className="official-logo" src="/ptak/logo.svg" alt="Ptak Stomatologia" loading="lazy" decoding="async"/></a><p>Wysoka jakość świadczonych usług<br/>i skuteczność leczenia.</p></div>
